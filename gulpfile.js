...
gulp.task('build:pages:assets', function() {
    gulp
        .src(['src/assets/**/*.?(png|jpg|gif|js|css)','!src/assets/js/jquery-weui.js'], option)
        .pipe(gulp.dest(dist))
});
...
gulp.task('uglify',function(){
    gulp.src('src/assets/js/jquery-weui.js')
        .pipe(uglify())
...
gulp.task('watch', ['release'], function() {
    gulp.watch('src/weui/**/*', ['build:weui','build:pages:style']);
    ...
    gulp.watch('src/assets/js/jquery-weui.js', ['uglify']);
});
